...
* Set up your working directories
	...
	* local datapath = "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2025-db\homework1" // Typically, where you keep the data and where you want the outputs to go will be different.  In this sample code, this is not the case so I don't specify a data path.
	local outputpath = "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2025-db\homework1\sample_code\output" 
...
* ON IAC VLAB server, you will need to uncomment this line, change to your username, and run this:
...
* Generate some random data
	...
	gen x3 = rnormal(15,30) // this variable we do not observe -- it is the error term
