...
local path "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2025-db\homework5"
local outputpath "C:\Users\brewe\Dropbox (Personal)\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2025-db\homework5\output"
...
* Question 1
    ...
    * Create a cohort variable
        ...
        bysort id: egen cohort2 = min(time) if treatment == 1
...
* Daily data
    ...
    bysort id: egen cohort2 = min(day) if treatment == 1
    bysort id: egen cohort = min(cohort2)
    drop cohort2
